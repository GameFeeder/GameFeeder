...
declare module 'feed-read_wrapper' {
  ...
  export function parseRSS(rss_string: string, callback: (err: Error, articles: Article[]) => void): void;

  export function parseAtom(atom_string: string, callback: (err: Error, articles: Article[]) => void): void;
